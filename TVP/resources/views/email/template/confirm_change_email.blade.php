...
<font size="2">
 <span style="font-size:11pt;">
    <div class="PlainText">Dear {{ config('server.serverName') }} player,<br>
       ...
       &nbsp;&nbsp; <a href="{{ route('account.lost.confirm.index', [$mailDetails['confirmationKey']]) }}">{{ route('account.lost.confirm.index', [$mailDetails['confirmationKey']]) }}</a><br>
       <br>
       ...
       <br>
       In case you encounter any problems using the above link, please go to <a href="{{ route('account.lost.confirm.index') }}">{{ route('account.lost.confirm.index') }}</a><br>
