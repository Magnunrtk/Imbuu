...
@section('content')
    ...
    <form role="form" action="{{ route('account.store.payment-method.tibia-coins.action') }}" method="post">
        @csrf
                                        ...
                                        <div class="TableContentContainer">
                                            <table class="TableContent" width="100%" style="border:1px solid #faf0d7;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="https://www.tibia.com/community/?name={{ config('shop.payment_options')['tibia_coins']['receiver_name'] }}" target="_blank">{{ config('shop.payment_options')['tibia_coins']['receiver_name'] }}</a></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">To complete the order, click confirm, we advise you to send the Tibia Coins before ordering to avoid misunderstandings.</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
