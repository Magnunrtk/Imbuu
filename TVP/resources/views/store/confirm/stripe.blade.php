...
@section('content')
    ...
    <form role="form" action="{{ route('account.store.payment-method.stripe.action') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ config('shop.payment_options')['stripe']['key'] }}" id="payment-form">
        @csrf
        ...
        <div class="SubmitButtonRow">
            <div class="LeftButton">
                <input type="hidden" name="payment_id" value="{{ $product->id }}">
