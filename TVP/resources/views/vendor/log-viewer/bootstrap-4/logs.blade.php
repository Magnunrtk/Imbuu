        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Logs
                    ...
                    <span class="text-muted fs-7 fw-bold mt-2">List</span>
                </h1>
            </div>
                            ...
                            <tr>
                                @foreach($row as $key => $value)
                                    <td class="{{ $key == 'date' ? 'text-left' : 'text-center' }}">
                                        ...
                                        @else
                                            <a href="{{ route('admin.logs.filter', [$date, $key]) }}">
                                ...
                                @endforeach
                                <td class="text-right">
                                    <a href="{{ route('admin.logs.show', [$date]) }}" class="btn btn-sm btn-info">
                                        <i class="fa fa-search"></i>
                                    </a>
                                    <a href="{{ route('admin.logs.download', [$date]) }}" class="btn btn-sm btn-success">
