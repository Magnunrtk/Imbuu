            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <div class="group-btns pull-right">
                        <a href="{{ route('admin.logs.download', [$log->date]) }}" class="btn btn-sm btn-success">
                ...
                <div class="card-footer">
                    {{-- Search --}}
                    <form action="{{ route('admin.logs.search', [$log->date, $level]) }}" method="GET">
                        <div class="form-group">
                            <div class="input-group">
                                <input id="query" name="query" class="form-control" value="{{ $query }}" placeholder="@lang('Type here to search')">
                                <div class="input-group-append">
                                    @unless (is_null($query))
                                        <a href="{{ route('admin.logs.show', [$log->date]) }}" class="btn btn-secondary">
...
@section('modals')
    ...
    <div id="delete-log-modal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <form id="delete-log-form" action="{{ route('admin.logs.delete') }}" method="POST">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.result === 'success') {
                            ...
                            location.replace("{{ route('admin.logs.list') }}");
                        }
                        else {
