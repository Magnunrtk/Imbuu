...
<div class="TableContainer">
    <div class="CaptionContainer">
        <div class="CaptionInnerContainer">
            ...
            <div class="Text">Password and Email Address Changed</div>
            ...
            <td>
                <div class="InnerTableContainer" style="max-width: unset;">
                    <table style="width:100%;">
                        <tbody>
                        <tr>
                            <td>You have successfully changed your account's email address.<br><br>Please log in with your new email address and your newly chosen password.</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
