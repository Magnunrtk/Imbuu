                    ...
                    <table style="width:100%;">
                        ...
                        <tr>
                            <td>
                                ...
                                <p>Please note that you will also need to choose a new password to complete the email change. Click on the link in the email or enter your data below to choose a new password.</p>
                            </td>
                        </tr>
                        </tbody>
                    </table>
...
<br>
@endif
<form action="{{ route('account.lost.confirm.action') }}" method="post" style="padding:0px;margin:0px;">
    @csrf
    <div class="TableContainer">
        <div class="CaptionContainer">
            <div class="CaptionInnerContainer">
                                ...
                                <td>
                                    <div class="TableContentContainer">
                                        <table class="TableContent" width="100%" style="border:1px solid #faf0d7;">
                                            <tbody>
                                            <tr>
                                                <td colspan="2"><label><input type="checkbox" name="confirmation" value="yes" @if(isset($confirmation)) checked="checked" @endif> Yes, I want to change my email address and choose a new password.<br></label></td>
                                            </tr>
                                            <tr>
                                                <td class="LabelV200">New Email Address:</td>
                                                <td>
                                                    @if(isset($email))
    ...
    <br><br>
    <center>
        <input type="hidden" name="step" value="setemailandpasswordcheckconfirmationkey">
