            ...
            <td>
                <div class="InnerTableContainer" style="max-width: unset;">
                    <table style="width:100%;">
                        <tbody>
                        <tr>
                            <td>If you have lost access to the assigned email address, try to get it back. For example, you can contact your email provider and ask for help. Once you have access to the assigned email address you can also get back access to your account via the Lost Account Interface. Please understand that if you cannot get access to your email address all you can do is to create a new account and start over.</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
