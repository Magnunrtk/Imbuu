...
@section('content')
<form action="{{ route('account.lost.confirm.action') }}" method="post" class="form">
    @csrf
    <input type="hidden" name="step" value="setemailandpasswordperform">
...
@section('scripts')
    <script type="text/javascript">
        function back() {
            ...
            let url = "{{ route('account.lost.confirm.action') }}";
            ...
            step.name = 'step';
            step.value = 'setemailandpasswordconfirm';
