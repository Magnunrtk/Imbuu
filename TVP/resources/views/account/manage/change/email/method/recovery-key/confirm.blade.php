            ...
            <tr>
                <td>
                    <div class="InnerTableContainer" style="max-width: unset;">
                        An email with a confirmation key has been sent to your new email address. To complete your email change, you need to choose a new password. To do so, click on the link in the email or enter the confirmation key here.<br><br>
                        <span class="LabelV">Confirmation Key:</span>
