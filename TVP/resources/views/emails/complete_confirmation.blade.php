...
<body>
    <div class="container">
        ...
        <div class="content" style="padding: 20px; font-family: Arial, sans-serif; font-size: 14px;">
            ...
            <p>Your account has been <strong>successfully confirmed</strong>.</p>

            Please save this key in a safe place. It is required to recover your account if you ever lose access.<br>

            <br>
            
            <code style="font-weight: bold; font-size: 15px; color: #e63946;"><strong style="color:black">Recovery Key (RK):</strong>{{ $actionLink }}</code></p>

            <p>If you did not request this account, you may ignore this email.<br>
