...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>You have requested to recover your password for your Ravenor account.</p>
            <p>To reset your password, please click on the link below:</p>
            <p><a href="{{ $actionLink }}">Recover Your Password</a></p>
            <p>For better security, we recommend keeping your new password in a safe and accessible place, such as a password manager. This will help you avoid losing access to your account in the future.</p>
            <p>If you did not request this password recovery, please ignore this email or contact our support team immediately.</p>
        </div>
