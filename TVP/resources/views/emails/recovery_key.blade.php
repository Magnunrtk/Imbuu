...
<head>
    <meta charset="UTF-8">
    <title>Recovery Key - Ravenor</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>You have requested a recovery key for your Ravenor account.</p>
            <p>Here is your unique recovery key. Please store it in a safe place and do not share it with anyone:</p>
            <p style="font-weight: bold; font-size: 18px; color: #FF5733; text-align: center;">{{ $actionLink }}</p>
            <p>If you did not request this key, please ignore this email or contact our support team immediately.</p>
        </div>

        <!-- Footer Section -->
        <div class="footer">
            <p>To view our rules, click <a href="https://ravenor.online/support/rules" target="_blank">here</a>.</p>
            <p>If you did not create this account or did not request the recovery, please ignore this email.</p>
        </div>
