...
<body>
    <div class="container">
        ...
        <div class="content" style="padding: 20px; font-family: Arial, sans-serif; font-size: 14px;">
            ...
            <p>Welcome to Ravenor, {{ $accountName }}!<br>Your account has been created. Below are your login details:</p>

            <p><strong>Login:</strong> {{ $accountNumber }}<br>
                <strong>Password:</strong> {{ $password }}</p>

            <p>To activate your account, please confirm your registration by clicking the link below:<br><a href="{{ $actionLink }}">Confirm your account</a></p>

            <p>If you did not register on our platform, please disregard this email.<br>To view our rules, click <a href="https://ravenor.online/support/rules" target="_blank">here</a>.</p>
