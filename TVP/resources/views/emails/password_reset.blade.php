...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p><a href="{{ $actionLink }}">Change Password</a></p>
            <p>If you did not request a password change, please ignore this email. Your password will remain unchanged.</p>
            <div class="rules-link">
                <p>If you need assistance, please refer to our <a href="https://ravenor.online/support/rules" target="_blank">Rules and Policies</a>.</p>
            </div>
        </div>        
    </div>    
</body>
