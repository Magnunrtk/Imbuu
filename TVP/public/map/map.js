var mapConfig = {
    imagesUrl: 'https://ravenor.online/map_tiled/', // URL to folder with 'zoom levels' (folders with names 0-16)
    imagesExtension: '.png',
    mapName: 'RL MAP?',
    startPosition: {x: 32365, y: 32216, z: 7},
    startZoom: 13,
    minZoom: 4,
    maxZoom: 18, // maximum zoom with full quality is 16

    streamPlayers: false, // stream on/off
    streamUpdateURL: './map/update.php',
    streamUpdateOutfitsURL: './map/update_outfits.php',
    ...
    // NPC & Monsters
    creaturesDataURL: false, //'creaturesData.php', // set 'false' to disable, set 'creaturesData.php' to make it load data
...
var followedIcon = new (L.Icon.Default.extend({
    options: {
        iconUrl: './map/libs/images/marker-icon-red.png'
    }
}))();
